...
Recently, I found that its copying text does not well. The solution can be found [here](https://github.com/homebrew-zathura/homebrew-zathura/issues/5).
...
-  [Shortcuts](https://defkey.com/zathura-shortcuts)